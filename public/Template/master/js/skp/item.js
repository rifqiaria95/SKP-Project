...
$(document).ready(function() {
    ...
    var tableOptions = {
        ...
        columns: [{
            ...
            {
                data: 'spesifikasi_item',
                name: 'spesifikasi_item'
            },
            {
                data: 'harga',
                name: 'harga'
    ...
    $('#table-item').DataTable(tableOptions);
});

// Function untuk tombol tambah item dan tampilkan modal
$(document).ready(function() {
    // $.noConflict();
    $('.btn_tambah').click(function() {
        // console.log($('#btn_tambah'));
        $('#btn-simpan').val("tambah-item");
        $('#tambahModal').modal('show');
        $('#formItem').trigger("reset");
        $('#modal-judul').html("Tambah Item");
    });
});
    ...
    $("#formItem").validate({
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                url: "/item/store", //url simpan data
                type: "POST", //data tipe kita kirim berupa JSON
                contentType: false,
                processData: false,
                success: function(response) {
                    var oTable = $('#table-item').dataTable(); //inialisasi datatable
