    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-12">
            ...
            <div class="user-profile-header-banner">
                {{-- <img src="{{ asset('Template/master/img/pages/profile-banner.png') }}" alt="Banner image" class="rounded-top" /> --}}
            </div>
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                <img
                    src="{{ asset('Template/master/img/avatars/14.png') }}"
                    alt="user image"
                ...
                >
                    ...
                    >
                        <li class="list-inline-item"><i class="ti ti-color-swatch"></i> {{ $karyawan->job_title }}</li>
        ...
        <div class="col-xl-4 col-lg-5 col-md-5">
            ...
            <div class="card-body">
                ...
                <li class="d-flex align-items-center mb-3">
                    <i class="ti ti-user"></i><span class="fw-bold mx-2">Nama Lengkap:</span> <span>{{ $karyawan->nama_lengkap() }}</span>
                </li>
                <li class="d-flex align-items-center mb-3">
