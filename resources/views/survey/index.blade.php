                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/survey/exportexcelsurvey" class="btn btn-success mb-5"><i data-feather='file'></i> Export Excel</a>
                                <a href="/survey/exportpdf" class="btn btn-danger mb-5"><i data-feather='file-text'></i> Export PDF</a>
                                <table id="table-survey" class="datatables-ajax table table-responsive">
                                    <thead>
                                        <tr>
                                            <th>Username</th>
                                            <th>E-mail</th>
            ...
            {{-- <div class="modal fade" tabindex="-1" role="dialog" id="modalHapus" data-backdrop="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><b>Jika menghapus survey maka</b></p>
                            <p>*data survey tersebut hilang selamanya, apakah anda yakin?</p>
                        </div>
                        <div class="modal-footer">
...
<script>
    ...
    // // Function untuk tombol tambah survey dan tampilkan modal
    // $(document).ready(function() {
    //     // $.noConflict();
    //     $('#btn_tambah').click(function() {
    //         // console.log($('#btn_tambah'));
    //         $('#btn-simpan').val("tambah-survey");
    //         $('#survey_id').val('');
    //         $('#tambahModal').modal('show');
    //         $('#formSurvey').trigger("reset");
    //         $('#modal-judul').html("Tambah Survey");
    //         $('#selectJK').select2({
    ...
    //                     var oTable = $('#table-survey').dataTable(); //inialisasi datatable
    ...
    //     $('#titleEdit').html("Edit Data Survey");
    ...
    //     e.preventDefault();
    //     $.ajax({
    //         url: "/survey/delete/" + id, //eksekusi ajax ke url ini
    //         type: 'delete',
    //         beforeSend: function() {
    ...
    //                 var oTable = $('#table-survey').dataTable();
    //                 oTable.fnDraw(false); //reset datatable
    //                 if (response.status == 404) {
    //                     toastr.success(response.message);
    //                 } else if (response.status == 200) {
