                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">
                                ...
                                serves.
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="page-auth-login-v2.html">Back to login</a><img class="img-fluid" src="{{ asset('Template/app-assets/images/pages/not-authorized.svg') }}" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
