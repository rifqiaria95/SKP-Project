                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-password-toggle">
                                        ...
                                        <select class="select2 form-select" id="selectPrioTB" name="priority" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-password-toggle">
                                        ...
                                        <select class="select2 form-select" id="selectStatusTB" name="task_status" required>
                    ...
                    <form id="formEdit" name="formEdit" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label class="form-label">Title</label>
                                    <input type="text" name="title" id="title" class="title form-control" value="" required>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Description</label>
                                    <textarea class="form-control" id="description" value="" placeholder="Enter description" name="description"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="multicol-password">Deadline</label>
                                        <input name="deadline" id="datePicker" value="" type="text" class="form-control date-picker" placeholder="DD-MM-YYYY" required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="multicol-confirm-password">Priority</label>
                                        <select class="select2 form-select" id="priority" name="priority" required>
                                            <option selected disabled>Choose Priority</option>
                                            <option value="Low">Low</option>
                                            <option value="Important">Important</option>
                                            <option value="High Priority">High Priority</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-password-toggle">
                                        <label class="form-label" for="multicol-confirm-password">Status</label>
                                        <select class="select2 form-select" id="task_status" name="task_status" required>
                                            <option selected disabled>Choose Status</option>
                                            <option value="Unfinished">Unfinished</option>
                                            <option value="On Progress">On Progress</option>
                                            <option value="Finished">Finished</option>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btn-hapus" data-target="#btn-hapus" class="btn btn-danger tambah_data" value="add">Confirm</button>
                    </div>
                </div>
            </div>
        </div>
