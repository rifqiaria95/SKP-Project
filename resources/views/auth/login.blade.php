<!DOCTYPE html>
<html class="loading" lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-textdirection="ltr"></html>
<!-- BEGIN: Head-->
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="#">
                            ...
                            <h2 class="brand-text text-primary ms-1">LHG</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form method="POST"  action="{{ route('login') }}" class="auth-login-form mt-2">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" name="email" required autocomplete="email" placeholder="Masukkan Email Anda" aria-describedby="login-email" autofocus="" tabindex="1" />
                                        @error('email')
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge @error('password') is-invalid @enderror" id="password" type="password" name="password" placeholder="············" required autocomplete="current-password" aria-describedby="login-password" tabindex="2" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
