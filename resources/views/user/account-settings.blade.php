                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                        ...
                                        <div class="d-flex">
                                            <a href="#" class="me-25">
                                                <img src="{{ asset('Template/app-assets/images/avatars/profile-image.jpg') }}" id="account-upload-img" class="rounded me-50" alt="profile image" height="80" width="80" />
                                            </a>
                                                        ...
                                                        <div class="col-6 col-md-3 text-center mb-1">
                                                            ...
                                                            <div class="avatar mb-1">
                                                                <span class="avatar-content">
                                                                    <img src="{{ asset('Template/app-assets/images/avatars/11-small.png') }}" alt="avatar img" width="40" height="40" />
                                                                </span>
                                                            </div>
