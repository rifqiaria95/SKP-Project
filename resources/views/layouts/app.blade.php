...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery-star-rating-plugin@4.11.0/jquery.rating.min.css" >
    <link rel="stylesheet" type="text/css" href="https://www.jqueryscript.net/css/jquerysctipttop.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('Template/app-assets/vendors/css/extensions/jquery.rateyo.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('Template/app-assets/css/fontawesome-stars.css') }}">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-bar-rating/1.2.2/themes/bars-1to10.min.css">
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('Template/app-assets/css/plugins/extensions/ext-component-ratings.css') }}">
