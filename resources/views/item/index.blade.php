...
@section('content')
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="card-body">
                    ...
                    <div class="content-left">
                        ...
                        <span>Diperbarui {{ $item[0]->created_at->diffForhumans() }}</span>
                    </div>
                    <span class="badge bg-label-primary rounded p-2">
                        <i class="ti ti-item ti-sm"></i>
                    </span>
                    </div>
                </div>
                </div>
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="card-body">
                    ...
                    <span class="badge bg-label-danger rounded p-2">
                        <i class="ti ti-item-plus ti-sm"></i>
                    </span>
                    </div>
                </div>
                </div>
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="card-body">
                    ...
                    <div class="content-left">
                        ...
                        <span>Diperbarui {{ $item[0]->updated_at->diffForhumans() }}</span>
                    </div>
                    <span class="badge bg-label-success rounded p-2">
                        <i class="ti ti-item-check ti-sm"></i>
                    </span>
                    </div>
                </div>
                </div>
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="card-body">
                    ...
                    <span class="badge bg-label-warning rounded p-2">
                        <i class="ti ti-item-exclamation ti-sm"></i>
                    </span>
                    </div>
                </div>
                </div>
            ...
            <div class="card-datatable table-responsive">
                <table id="table-item" class="datatables-users table border-top">
                <thead>
                    <tr>
                        <th>Nama Item</th>
                        <th>Spesifikasi</th>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_item" class="nama_item form-control" placeholder="Masukkan Nama Item" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" name="spesifikasi_item" placeholder="Masukkan Spesifkasi Item" required></textarea>
                                    </div>
                                    <div class="col-md-6">
...
@section ('script')
    ...
    <script src="{{ asset('Template/master/js/skp/item.js') }}"></script>
@endsection